...
# --- ⚙️ PARAMÈTRES V45 = V40 BASE + NO LIMITS (TARGET: 2000%+) ---
EMA_SHORT_PERIOD = 2      
EMA_LONG_PERIOD = 4       
EMA_EXIT_PERIOD = 2       
EMA_ULTRA_LONG_PERIOD = 5

VOLATILITY_PERIOD = 2     # MINIMAL

TREND_CONFIRMATION_THRESHOLD = 0.000001  # MINIMAL ABSOLU
MOMENTUM_SLOWDOWN_THRESHOLD = 0.000001   # MINIMAL ABSOLU

VOLATILITY_CUTOFF = 1.00  # 1000% - NEVER TRIGGER

# Kelly Criterion V46 MAX LEGAL
BASE_MAX_RISK_ALLOCATION = 0.99  
KELLY_MAX_CAP = 0.99      # MAX LEGAL
KELLY_MIN_TRADES = 1      # IMMÉDIAT

# Paramètres V46 ULTRA
RSI_PERIOD = 4            
RSI_OVERSOLD = 40         
RSI_OVERBOUGHT = 70       
MOMENTUM_BOOST_MULTIPLIER = 7.5  
PYRAMIDING_PROFIT_THRESHOLD = 0.003  # 0.3%
PYRAMIDING_MAX_MULT = 12.0  # x12

# Breakout et trend V46
BREAKOUT_LOOKBACK = 8     
BREAKOUT_BOOST = 8.0      
TREND_STRENGTH_BOOST = 8.5
